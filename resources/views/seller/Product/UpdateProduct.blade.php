                ...
                <div class="col-12 mt-5">
                    <div class="d-flex justify-content-center  ">
                        <div class="col-10 ">
                            ...
                            <form action="{{ route('product.updateProduct', ['productDetails' => $productDetails]) }}" method="post" encType="multipart/form-data"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" name="thumbnail" id="thumbnail"
                                                ...
                                                accept="mage/jpg,image/jpeg,image/webp,image/png"   value="{{ old('thumbnail', $productDetails->thumbnail) }}"/>
