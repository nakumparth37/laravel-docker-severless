            ...
            <div class="row">
                <div class="col-12 mt-5">
                    <div class="d-flex justify-content-center  ">
                        <div class="col-10 ">
                            <h3 class="mb-5 pb-2 fs-2">Update product</h3>
                            <form action="{{ route('product.updateProduct', ['productDetails' => $productDetails]) }}"
                                method="post" encType="multipart/form-data" class="addProduct" id="addProduct">
                                @csrf
                                <div class="row">
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" id="title"
                                                ...
                                                placeholder="Enter Product Title" aria-describedby="e_title"
                                                value="{{ old('title', $productDetails->title) }}" />
                                            @if ($errors->has('title'))
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="brand" id="brand"
                                                ...
                                                placeholder="Enter Brand Name" aria-describedby="e_brand"
                                                value="{{ old('brand', $productDetails->brand) }}" />
                                            @if ($errors->has('brand'))
                                ...
                                <div class="row mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($categories as $categorie)
                                                        <option value="{{ $categorie->id }}" @selected(old('id') == $categorie->id)
                                                            @selected($productDetails->categoryId == $categorie->id)>
                                    ...
                                    <div class="col-4">
                                        <div class="mb-3">
                                            <div class="mb-3 " id="hiddeSubCategory">
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($subCategories as $subCategory)
                                                        <option value="{{ $subCategory->id }}" @selected($productDetails->sub_categoryId == $subCategory->id)>
                                        ...
                                        <div class="mb-3">
                                            <div class="mb-3">
                                                ...
                                                <select
                                                    ...
                                                    <option value="{{ $seller->id }}" @selected($productDetails->sellerId == $seller->id)>
                                                        {{ $seller->name }}
                                                    </option>
                                                @endforeach
                                                </select>
                                    ...
                                    <div class="col-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="discountPercentage" id="discount"
                                                ...
                                                aria-describedby="e_discountPercentage"
                                                value="{{ old('discountPercentage', $productDetails->discountPercentage) }}" />
                                    ...
                                    <div class="col-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="stock" id="stock"
                                                ...
                                                placeholder="Enter Product Stock" aria-describedby="e_stock"
                                    ...
                                    <div class="col-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="price" id="price"
                                                ...
                                                placeholder="Enter Product price" aria-describedby="e_price"
                                ...
                                <div class="row my-3">
                                    <div class="col-6 thumbnailPreview">
                                        <img src="{{ $productDetails->thumbnail }}" width="250px" />
                                    </div>
                                    <div class="d-flex align-items-center flex-wrap col-6 imagesPreview">
                                        @foreach ($productDetails->images as $image)
                                            <img src="{{ $image }}" width="120px" class="m-2" />
                                        @endforeach
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" name="thumbnail" id="thumbnail"
                                                ...
                                                value="{{ old('thumbnail', $productDetails->thumbnail) }}" />
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description"
                                        rows="6" placeholder="Enter Product Description" aria-describedby="e_description"
                                        value="{{ old('description', $productDetails->description) }}">{{ old('description', $productDetails->description) }}</textarea>
