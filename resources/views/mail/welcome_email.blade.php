                                    ...
                                    <td align="center" class="" valign="top">
                                        ...
                                        <table bgcolor="#fff" cellpadding="0" cellspacing="0" class=""
                                            ...
                                            <tbody style="margin-top: 15px;">
                                                ...
                                                <tr class="">
                                                    <td class="headline">Welcome to <strong
                                                            style="color:#fa5700;">E-commerce!</strong></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <center class="">
                                                                ...
                                                                <tbody class="">
                                                                    <tr class="">
                                                                        <td class=""
                                                                            ...
                                                                            <br><br><strong style="color:#fa5700;">{{ $data['name'] }}</strong>
                                                                            Welcome to E-commerce ! We're thrilled to
                                                                            have you join our community. As a new
                                                                            member, you're now part of a vibrant
                                                                            ...
                                                                            <span style="font-weight:bold;">Email:
                                                                                ...
                                                                                class="">{{ $data['email'] }}</span>
                                                                            <br>
                                                                            <span style="font-weight:bold;">Password:
                                                                                &nbsp;</span><span
                                                                                style="font-weight:lighter;"
                                                                                class="">{{ $data['password'] }}</span>
                                                                            <hr>
                                                                            <br>
                                                                        </td>
                                                                    </tr>
